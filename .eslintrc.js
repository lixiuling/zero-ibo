...
module.exports = {
  ...
  env: {
    ...
    jasmine: true,
    jest: true,
    es6: true, // 自动启用es6语法（启用除了 modules 以外的所有 ECMAScript 6 特性（该选项会自动设置 ecmaVersion 解析器选项为 6））
  },
  settings: {
  ...
  rules: {
    ...
    'react/jsx-max-props-per-line': [1, { maximum: 1, when: 'multiline' }], // 限制JSX中单行上的props的最大数量
